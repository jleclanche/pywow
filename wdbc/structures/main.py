...
#			(IntegerField, "amount"),
#		), 10]),
		IntegerField("stats_id_1"),
		IntegerField("stats_amount_1"),
		IntegerField("stats_id_2"),
		IntegerField("stats_amount_2"),
		IntegerField("stats_id_3"),
		IntegerField("stats_amount_3"),
		IntegerField("stats_id_4"),
		IntegerField("stats_amount_4"),
		IntegerField("stats_id_5"),
		IntegerField("stats_amount_5"),
		IntegerField("stats_id_6"),
		IntegerField("stats_amount_6"),
		IntegerField("stats_id_7"),
		IntegerField("stats_amount_7"),
		IntegerField("stats_id_8"),
		IntegerField("stats_amount_8"),
		IntegerField("stats_id_9"),
		IntegerField("stats_amount_9"),
		IntegerField("stats_id_10"),
		IntegerField("stats_amount_10"),
		...
		IntegerField("socket_1"),
		IntegerField("socket_info_1"),
		IntegerField("socket_2"),
		IntegerField("socket_info_2"),
		IntegerField("socket_3"),
	...
	def changed_8471(self, fields):
		...
		fields.delete_fields(
			"stats_id_1", "stats_amount_1",
			"stats_id_2", "stats_amount_2",
			"stats_id_3", "stats_amount_3",
			"stats_id_4", "stats_amount_4",
			"stats_id_5", "stats_amount_5",
			"stats_id_6", "stats_amount_6",
			"stats_id_7", "stats_amount_7",
			"stats_id_8", "stats_amount_8",
			"stats_id_9", "stats_amount_9",
			"stats_id_10", "stats_amount_10",
		)
		fields.insert_field(
			DynamicFields("stats", ((
				(IntegerField, "id"),
...
class NPCCache(Structure):
	...
	fields = Skeleton(
		IDField(),
		RecLenField(),
		FloatField("probability_1"),
		StringField("text_male_1"),
		StringField("text_female_1"),
		IntegerField(),
		IntegerField(),
		IntegerField(),
		IntegerField(),
		...
		IntegerField(),
		IntegerField(),
		FloatField("probability_2"),
		StringField("text_male_2"),
		StringField("text_female_2"),
		IntegerField(),
		IntegerField(),
		IntegerField(),
		IntegerField(),
		...
		IntegerField(),
		IntegerField(),
		FloatField("probability_3"),
		StringField("text_male_3"),
		StringField("text_female_3"),
		IntegerField(),
		IntegerField(),
		IntegerField(),
		IntegerField(),
		...
		IntegerField(),
		IntegerField(),
		FloatField("probability_4"),
		StringField("text_male_4"),
		StringField("text_female_4"),
		IntegerField(),
		IntegerField(),
		IntegerField(),
		IntegerField(),
		...
		IntegerField(),
		IntegerField(),
		FloatField("probability_5"),
		StringField("text_male_5"),
		StringField("text_female_5"),
		IntegerField(),
		IntegerField(),
		IntegerField(),
		IntegerField(),
		...
		IntegerField(),
		IntegerField(),
		FloatField("probability_6"),
		StringField("text_male_6"),
		StringField("text_female_6"),
		IntegerField(),
		IntegerField(),
		IntegerField(),
		IntegerField(),
		...
		IntegerField(),
		IntegerField(),
		FloatField("probability_7"),
		StringField("text_male_7"),
		StringField("text_female_7"),
		IntegerField(),
		IntegerField(),
		IntegerField(),
		IntegerField(),
		...
		IntegerField(),
		IntegerField(),
		FloatField("probability_8"),
		StringField("text_male_8"),
		StringField("text_female_8"),
		IntegerField(),
		IntegerField(),
		IntegerField(),
		IntegerField(),
...
class Item_sparse(Structure):
	...
	fields = Skeleton(
		...
		IntegerField("stats_amount_9"),
		IntegerField("stats_amount_10"),
		IntegerField("stats_unk1_1"),
		IntegerField("stats_unk1_2"),
		IntegerField("stats_unk1_3"),
		IntegerField("stats_unk1_4"),
		IntegerField("stats_unk1_5"),
		IntegerField("stats_unk1_6"),
		IntegerField("stats_unk1_7"),
		IntegerField("stats_unk1_8"),
		IntegerField("stats_unk1_9"),
		IntegerField("stats_unk1_10"),
		IntegerField("stats_unk2_1"),
		IntegerField("stats_unk2_2"),
		IntegerField("stats_unk2_3"),
		IntegerField("stats_unk2_4"),
		IntegerField("stats_unk2_5"),
		IntegerField("stats_unk2_6"),
		IntegerField("stats_unk2_7"),
		IntegerField("stats_unk2_8"),
		IntegerField("stats_unk2_9"),
		IntegerField("stats_unk2_10"),
		ForeignKey("scaling_stats", "ScalingStatDistribution"),
		IntegerField("damage_type"),
		IntegerField("speed"),
		FloatField("range"),
		ForeignKey("spell_1", "Spell"),
		...
		IntegerField("sheath_type"),
		ForeignKey("random_enchantment", "ItemRandomProperties"),
		ForeignKey("random_suffix", "ItemRandomSuffix"),
		ForeignKey("itemset", "ItemSet"),
		IntegerField("durability"),
		ForeignKey("required_zone", "AreaTable"),
		ForeignKey("required_instance", "Map"),
		BitMaskField("bag_category"),
		ForeignKey("tool_category", "TotemCategory"),
		IntegerField("socket_1"),
		IntegerField("socket_2"),
		...
		ForeignKey("socket_bonus", "SpellItemEnchantment"),
		ForeignKey("gem_properties", "GemProperties"),
		FloatField("budget_modifier"),
		DurationField("duration", unit="seconds"),
...
class ItemExtendedCost(Structure):
	...
	def changed_11927(self, fields):
		self.changed_10026(fields)
		fields.append_fields(
			ForeignKey("currency_1", "CurrencyTypes"),
			ForeignKey("currency_2", "CurrencyTypes"),
			ForeignKey("currency_3", "CurrencyTypes"),
			ForeignKey("currency_4", "CurrencyTypes"),
			ForeignKey("currency_5", "CurrencyTypes"),
			IntegerField("currency_amount_1"),
			IntegerField("currency_amount_2"),
			IntegerField("currency_amount_3"),
			IntegerField("currency_amount_4"),
			IntegerField("currency_amount_5"),
			UnknownField(),
			UnknownField(),
			UnknownField(),
			UnknownField(),
...
class SpellScaling(Structure):
	...
	fields = Skeleton(
		...
		FloatField("coefficient_2_effect_1"),
		FloatField("coefficient_2_effect_2"),
		FloatField("coefficient_2_effect_3"),
		FloatField("coefficient_3_effect_1"),
...
class Talent(Structure):
	...
	fields = Skeleton(
		...
		ForeignKey("depends", "Talent"),
		ForeignKey("depends_right", "Talent"),
		ForeignKey("depends_left", "Talent"),
		IntegerField("depends_count"),
		IntegerField("depends_right_count"),
		IntegerField("depends_left_count"),
		BooleanField("active"),
		UnknownField(),
...
class Vehicle(Structure):
	...
	fields = Skeleton(
		IDField(),
		BitMaskField("flags"),
		FloatField("turn_speed"),
		FloatField("pitch_speed"),
		FloatField("pitch_min"),
		FloatField("pitch_max"),
		ForeignKey("seat_1", "VehicleSeat"),
		ForeignKey("seat_2", "VehicleSeat"),
		ForeignKey("seat_3", "VehicleSeat"),
		ForeignKey("seat_4", "VehicleSeat"),
		ForeignKey("seat_5", "VehicleSeat"),
		ForeignKey("seat_6", "VehicleSeat"),
		ForeignKey("seat_7", "VehicleSeat"),
		ForeignKey("seat_8", "VehicleSeat"),
		FloatField("mouse_look_offset_pitch"),
		FloatField("camera_fade_dist_scalar_min"),
		FloatField("camera_fade_dist_scalar_max"),
		FloatField("camera_pitch_offset"),
		FloatField(),
		FloatField(),
		FloatField(),
		FloatField(),
...
class VehicleSeat(Structure):
	...
	fields = Skeleton(
		IDField(),
		BitMaskField("flags"),
		IntegerField("attachment"),
		FloatField("attachment_offset_x"),
		FloatField("attachment_offset_y"),
		FloatField("attachment_offset_z"),
		FloatField("enter_delay"),
		FloatField("enter_speed"),
		FloatField("enter_gravity"),
		FloatField("enter_duration_min"),
		FloatField("enter_duration_max"),
		FloatField("enter_arc_height_min"),
		FloatField("enter_arc_height_max"),
		IntegerField("enter_anim_start"),
		IntegerField("enter_anim_loop"),
		IntegerField("ride_anim_start"),
		IntegerField("ride_anim_loop"),
		IntegerField("ride_upper_anim_start"),
		IntegerField("ride_upper_anim_loop"),
		FloatField("exit_delay"),
		FloatField("exit_speed"),
		FloatField("exit_duration_min"),
		FloatField("exit_duration_max"),
		FloatField("exit_arc_height_min"),
		FloatField("exit_arc_height_max"),
		FloatField(),
		IntegerField("exit_anim_start"),
		IntegerField("exit_anim_end"),
		IntegerField("exit_anim_loop"),
		FloatField("passenger_yaw"),
		FloatField("passenger_pitch"),
		FloatField("passenger_roll"),
		IntegerField("passenger_attachment"),
		IntegerField("vehicle_enter_anim"),
		IntegerField("vehicle_exit_anim"),
		IntegerField("vehicle_ride_anim_loop"),
		IntegerField("vehicle_enter_anim_bone"),
		IntegerField("vehicle_exit_anim_bone"),
		IntegerField("vehicle_ride_anim_loop_bone"),
		FloatField("vehicle_enter_anim_delay"),
		FloatField("vehicle_exit_anim_delay"),
		IntegerField("vehicle_ability_display"),
		IntegerField("enter_ui_sound"), # fk
		IntegerField("exit_ui_sound"), # fk
		IntegerField("skin"),
		BitMaskField("flags_2"),
		FloatField(),
		FloatField(),
