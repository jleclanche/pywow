...
#		), 10]),
		...
		IntegerField("stats_amt_1"),
		IntegerField("stats_id_2"),
		IntegerField("stats_amt_2"),
		IntegerField("stats_id_3"),
		IntegerField("stats_amt_3"),
		IntegerField("stats_id_4"),
		IntegerField("stats_amt_4"),
		IntegerField("stats_id_5"),
		IntegerField("stats_amt_5"),
		IntegerField("stats_id_6"),
		IntegerField("stats_amt_6"),
		IntegerField("stats_id_7"),
		IntegerField("stats_amt_7"),
		IntegerField("stats_id_8"),
		IntegerField("stats_amt_8"),
		IntegerField("stats_id_9"),
		IntegerField("stats_amt_9"),
		IntegerField("stats_id_10"),
		IntegerField("stats_amt_10"),
	...
	def changed_8471(self, fields):
		...
		fields.delete_fields(
			"stats_id_1", "stats_amt_1",
			"stats_id_2", "stats_amt_2",
			"stats_id_3", "stats_amt_3",
			"stats_id_4", "stats_amt_4",
			"stats_id_5", "stats_amt_5",
			"stats_id_6", "stats_amt_6",
			"stats_id_7", "stats_amt_7",
			"stats_id_8", "stats_amt_8",
			"stats_id_9", "stats_amt_9",
			"stats_id_10", "stats_amt_10",
		)
		fields.insert_field(
			DynamicFields("stats", ((
				(IntegerField, "id"),
